...
{
    #ifdef tx_int_INTERRUPT_INTERRUPT_CALLBACK
        tx_int_Interrupt_InterruptCallback();
    #endif /* tx_int_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling tx_int_Start or tx_int_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after tx_int_Start or tx_int_StartEx has been called. 
